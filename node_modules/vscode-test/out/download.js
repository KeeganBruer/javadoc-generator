        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, version === 'insiders' || validVersions.includes(version)];
            }
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var requestOptions = util_1.urlToOptions(util_1.getVSCodeDownloadUrl(version));
            ...
            switch (_a.label) {
                ...
                case 4:
                    if (fs.existsSync(path.resolve(vscodeTestDir, "vscode-" + version))) {
                        ...
                        return [2 /*return*/, Promise.resolve(util_1.downloadDirToExecutablePath(path.resolve(vscodeTestDir, "vscode-" + version)))];
                    }
